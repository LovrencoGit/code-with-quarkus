...
public class AuthService {
    ...
    public LoginResponse generateAuthResponse(LoginRequest login) {
        ...
        return LoginResponse.builder()
                .accessToken(jwtTokenService.generateAccessToken(user.getId(), login.getUsername(), uuid))
                .refreshToken(jwtTokenService.generateRefreshToken(user.getId(), login.getUsername(), uuid))
                .build();
    }
